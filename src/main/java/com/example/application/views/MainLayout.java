...
import com.example.application.views.listacontactos.ListaContactosView;
import com.example.application.views.nuevocontacto.NuevoContactoView;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        Span appName = new Span("Contactos 2");
